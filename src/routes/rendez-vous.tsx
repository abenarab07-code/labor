  ...
  head: () => ({
    meta: [
      { title: "Demander un rendez-vous — Laboratoire Dr Tarfaya" },
      {
        name: "description",
        content:
          "Demandez un rendez-vous pour une analyse médicale ou une consultation en hématologie au laboratoire Dr Tarfaya à Annaba, El Bouni.",
      },
        ...
        <div className="container-editorial grid gap-10 lg:grid-cols-12">
          <div className="lg:col-span-5">
            ...
            <p className="mt-5 max-w-md text-sm leading-6 text-ink/70 sm:text-base">
              Analyse médicale ou consultation en hématologie : indiquez votre
              besoin et l'équipe vous recontactera selon la disponibilité du
              service.
            </p>
