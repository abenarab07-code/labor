...
export function LaboratoryHero() {
  ...
  return (
    <section
      ref={ref}
      className="relative min-h-[100svh] overflow-hidden bg-[#f4f8fc] pb-20 pt-28 text-midnight md:pb-28 md:pt-32"
    >
      ...
      <div className="container-editorial relative grid min-h-[calc(100svh-12rem)] items-center gap-16 lg:grid-cols-12 lg:gap-12">
        ...
        >
          ...
          <h1 className="max-w-[11ch] font-display text-[clamp(3.35rem,7vw,7.3rem)] leading-[0.88] tracking-[-0.055em] text-midnight">
          ...
          <p className="mt-7 max-w-xl text-base leading-7 text-slate md:text-lg">
            ...
            <span dir="rtl" className="mt-2 block font-medium text-midnight/80">
          ...
          <div className="mt-8 flex flex-wrap gap-3">
            ...
            <a
              ...
              className="inline-flex items-center gap-3 rounded-full border border-midnight/14 bg-white/72 px-6 py-4 text-sm font-semibold text-midnight transition-colors hover:border-blue hover:text-blue"
            >
              Préparer mon analyse
            </a>
          </div>

          <div className="mt-10 grid max-w-xl grid-cols-3 border-y border-midnight/10">
            {[
              ...
              return (
                <div
                  key={label as string}
                  className={`flex items-center gap-2 py-4 ${index ? "border-l border-midnight/10 pl-3 sm:pl-5" : ""}`}
                >
                  <IconComponent className="h-3.5 w-3.5 shrink-0 text-coral" />
                  <span className="text-[0.58rem] font-semibold uppercase tracking-[0.1em] text-midnight/58 sm:text-[0.65rem]">
                    {label as string}
                  </span>
                </div>
              );
        ...
        >
          <div
            aria-hidden="true"
            className="absolute -inset-5 rounded-[2.25rem] border border-blue/12 bg-white/30 shadow-[0_30px_80px_-55px_rgba(20,110,245,0.6)]"
          />
          ...
          <div className="relative" style={{ transformStyle: "preserve-3d" }}>
            ...
            >
              <div className="relative aspect-[4/5] overflow-hidden rounded-[1.8rem] border border-blue/16 bg-midnight shadow-[0_48px_90px_-42px_rgba(7,26,43,0.48)]">
